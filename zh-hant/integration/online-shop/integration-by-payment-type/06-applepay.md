...
:::info Android 裝置不支援 Apple Pay，若用戶於 Android 裝置選擇 Apple Pay，按鈕將自動隱藏。 :::
...
:::warning 若使用者將其 Apple Store 區域或系統語言設定為中國大陸，此功能將無法使用。 :::

<Link href="https://sdk.qfapi.com/images/applepay_qrcode.png" target="_blank">
  ![Apple Pay QRCode 範例](@site/static/img/applepay_qrcode.png)
</Link>